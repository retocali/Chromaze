...
public class PlateBehavior : MonoBehaviour {
	...
	void Start () {
		...
		// For sharing materials between plates of the same color
		...
		// For checking for mixed colored plates
	...
	// Activates the plate when a player steps on it or
	// when a box of the same color or multiple boxes
	// that create the same color are on it
